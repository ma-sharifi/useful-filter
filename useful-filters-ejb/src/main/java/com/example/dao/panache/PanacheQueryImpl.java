...
import com.example.panache.common.Page;
...
public class PanacheQueryImpl<Entity> implements PanacheQuery<Entity> {
    ...
    public PanacheQueryImpl(EntityManager em, javax.persistence.Query jpaQuery, String query, Object paramsArrayOrMap) {
        this.em = em;
...
//                JpaOperations.bindParameters(countQuery, (Map<String, Object>) paramsArrayOrMap); // todo msh
//            else
